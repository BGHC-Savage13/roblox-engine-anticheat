// --generated by Hacsu8166Alt
// --Created BY 789239823.
...
, function(t, w, S) {
    ...
    (function(t, e, n) {
        ...
        function h(t) {
            try {
                for (var e = t, n = [], r = 0, o = 0, i = " > ".length, a = void 0; e && r++ < 5 && !("html" === (a = v(e)) || 1 < r && 80 <= o + n.length * i + a.length); )
                    n.push(a),
                    o += a.length,
                    e = e.parentNode;
        ...
        var _ = Date.now()
          ...
          , m = function() {
            ...
            var t = i().performance;
            return t && t.now ? (void 0 === t.timeOrigin && (t.timeOrigin = t.timing && t.timing.navigationStart || _),
            t) : g
        }();
        function b() {
    ...
    (function(n) {
        ...
        function l(t) {
            ...
            if (Object(c.f)(t)) {
                ...
                for (var r in "undefined" != typeof CustomEvent && Object(c.g)(t, CustomEvent) && (i.detail = o.detail),
                o)
        ...
        function f(t, e, n, r) {
            ...
            if (r.memoize(e))
                return "[Circular ~]";
            for (var s in i)
                Object.prototype.hasOwnProperty.call(i, s) && (a[s] = f(s, i[s], n - 1, r));
        ...
        function h(t, e) {
            ...
            if (n[0].length >= e)
                return Object(i.d)(n[0], e);
            for (var r = n.length; 0 < r; r--) {
                var o = n.slice(0, r).join(", ");
                if (!(o.length > e))
                    return r === n.length ? o : Object(i.d)(o, e)
            }
            return ""
        }
    }
...
, function(t, e, n) {
    ...
    ,
    u.id = "FunctionToString",
    u);
    function u() {
        this.name = u.id
    }
    var l, p, h = n(0), f = n(2);
    (p = l = l || {}).PENDING = "PENDING",
    p.RESOLVED = "RESOLVED",
    p.REJECTED = "REJECTED";
    ...
    function v(t) {
        ...
        this._setResult = function(t, e) {
            n._state === l.PENDING && (Object(f.m)(e) ? e.then(n._resolve, n._reject) : (n._state = t,
            n._value = e,
            n._executeHandlers()))
        }
        ,
        ...
        this._executeHandlers = function() {
            if (n._state !== l.PENDING) {
                ...
                t.forEach(function(t) {
                    t.done || (n._state === l.RESOLVED && t.onfulfilled && t.onfulfilled(n._value),
                    n._state === l.REJECTED && t.onrejected && t.onrejected(n._value),
                    t.done = !0)
                })
            }
        }
    ...
    g.prototype.setTags = function(t) {
        return this._tags = h.a({}, this._tags, t),
        this._notifyScopeListeners(),
        this
    }
    ,
    g.prototype.setTag = function(t, e) {
        var n;
        return this._tags = h.a({}, this._tags, ((n = {})[t] = e,
        n)),
        this._notifyScopeListeners(),
        this
    }
    ...
    g.prototype.setExtras = function(t) {
        return this._extra = h.a({}, this._extra, t),
        this._notifyScopeListeners(),
        this
    }
    ,
    g.prototype.setExtra = function(t, e) {
        var n;
        return this._extra = h.a({}, this._extra, ((n = {})[t] = e,
        n)),
        this._notifyScopeListeners(),
        this
    }
    ...
    g.prototype.setContext = function(t, e) {
        var n;
        return this._contexts = h.a({}, this._contexts, ((n = {})[t] = e,
        n)),
        this._notifyScopeListeners(),
        this
    }
    ...
    g.clone = function(t) {
        var e = new g;
        return t && (e._breadcrumbs = h.d(t._breadcrumbs),
        e._tags = h.a({}, t._tags),
        e._extra = h.a({}, t._extra),
        e._contexts = h.a({}, t._contexts),
        e._user = t._user,
        e._level = t._level,
        e._span = t._span,
        e._transactionName = t._transactionName,
        e._fingerprint = t._fingerprint,
        e._eventProcessors = h.d(t._eventProcessors)),
        e
    }
    ,
    g.prototype.update = function(t) {
        ...
        if ("function" != typeof t)
            return t instanceof g ? (this._tags = h.a({}, this._tags, t._tags),
            this._extra = h.a({}, this._extra, t._extra),
            this._contexts = h.a({}, this._contexts, t._contexts),
            t._user && (this._user = t._user),
            t._level && (this._level = t._level),
            t._fingerprint && (this._fingerprint = t._fingerprint)) : Object(f.h)(t) && (t = t,
            this._tags = h.a({}, this._tags, t.tags),
            this._extra = h.a({}, this._extra, t.extra),
            this._contexts = h.a({}, this._contexts, t.contexts),
    ...
    g.prototype.addBreadcrumb = function(t, e) {
        ...
        return this._breadcrumbs = void 0 !== e && 0 <= e ? h.d(this._breadcrumbs, [n]).slice(-e) : h.d(this._breadcrumbs, [n]),
        this._notifyScopeListeners(),
        this
    }
    ,
    ...
    g.prototype.applyToEvent = function(t, e) {
        return this._extra && Object.keys(this._extra).length && (t.extra = h.a({}, this._extra, t.extra)),
        this._tags && Object.keys(this._tags).length && (t.tags = h.a({}, this._tags, t.tags)),
        this._user && Object.keys(this._user).length && (t.user = h.a({}, this._user, t.user)),
        this._contexts && Object.keys(this._contexts).length && (t.contexts = h.a({}, this._contexts, t.contexts)),
        this._level && (t.level = this._level),
        this._transactionName && (t.transaction = this._transactionName),
        this._span && (t.contexts = h.a({
            trace: this._span.getTraceContext()
        }, t.contexts)),
        this._applyFingerprint(t),
        t.breadcrumbs = h.d(t.breadcrumbs || [], this._breadcrumbs),
        t.breadcrumbs = 0 < t.breadcrumbs.length ? t.breadcrumbs : void 0,
        this._notifyEventProcessors(h.d(m(), this._eventProcessors), t, e)
    }
    ,
    g);
    function g() {
    ...
    T.prototype.getIntegration = function(e) {
        ...
        try {
            ...
            return w.warn("Cannot retrieve integration " + e.id + " from the current Hub"),
            null
        }
    }
    ,
    ...
    function N() {
        var t = R();
        return D(t) && !U(t).isOlderThan(S) || C(t, new k),
        Object(_.i)() ? function(e) {
            try {
                var t = R().__SENTRY__;
    ...
    M.prototype._shouldDropEvent = function(t, e) {
        ...
        !0) : this._isIgnoredError(t, e) ? (w.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: " + Object(_.d)(t)),
        !0) : this._isDeniedUrl(t, e) ? (w.warn("Event dropped due to being matched by `denyUrls` option.\nEvent: " + Object(_.d)(t) + ".\nUrl: " + this._getEventFilterUrl(t)),
        !0) : !this._isAllowedUrl(t, e) && (w.warn("Event dropped due to not being matched by `allowUrls` option.\nEvent: " + Object(_.d)(t) + ".\nUrl: " + this._getEventFilterUrl(t)),
        !0)
    }
    ,
    ...
    M.prototype._getEventFilterUrl = function(e) {
        try {
            ...
            return w.error("Cannot extract url for event " + Object(_.d)(e)),
            null
        }
    }
    ,
    ...
    X.prototype._fromString = function(t) {
        ...
        var n = h.c(e.slice(1), 6)
          ...
          , p = n[5]
          , f = p.split("/");
        if (1 < f.length && (l = f.slice(0, -1).join("/"),
        p = f.pop()),
        p) {
            var d = p.match(/^\d+/);
            d && (p = d[0])
    ...
    X.prototype._validate = function() {
        ...
        if (["protocol", "user", "host", "projectId"].forEach(function(t) {
            if (!e[t])
                throw new H(Y + ": " + t + " missing")
        }),
        !this.projectId.match(/^\d+$/))
            throw new H(Y + ": Invalid projectId " + this.projectId);
        if ("http" !== this.protocol && "https" !== this.protocol)
            throw new H(Y + ": Invalid protocol " + this.protocol);
        if (this.port && isNaN(parseInt(this.port, 10)))
            throw new H(Y + ": Invalid port " + this.port)
    }
    ,
    X);
    function X(t) {
    ...
    function $(t) {
        ...
        return function(t) {
            ...
            if (Array.isArray(n)) {
                ...
                r = "function" == typeof n ? (r = n(e),
                Array.isArray(r) ? r : [r]) : h.d(e);
            var a = r.map(function(t) {
                return t.name
            });
            return -1 !== a.indexOf("Debug") && r.push.apply(r, h.d(r.splice(a.indexOf("Debug"), 1))),
            r
        }(t).forEach(function(t) {
            !function(t) {
                -1 === z.indexOf(t.name) && (t.setupOnce(b, N),
                z.push(t.name),
    ...
    tt.prototype.captureMessage = function(t, e, n, r) {
        var o = this
          , i = n && n.event_id;
        return this._processing = !0,
        (Object(f.i)(t) ? this._getBackend().eventFromMessage("" + t, e, n) : this._getBackend().eventFromException(t, n)).then(function(t) {
    ...
    tt.prototype.getIntegration = function(e) {
        try {
            ...
            return w.warn("Cannot retrieve integration " + e.id + " from the current Client"),
            null
        }
    }
    ,
    ...
    tt.prototype._applyClientOptions = function(t) {
        ...
        t.message && (t.message = Object(L.d)(t.message, a));
    ...
    tt.prototype._processEvent = function(t, i, e) {
        var a = this
          ...
          , r = n.sampleRate;
        if (!this._isEnabled())
            return d.reject("SDK not enabled, will not send event.");
        ...
        return !c && "number" == typeof r && Math.random() > r ? d.reject("This event has been sampled, will not send event.") : new d(function(r, o) {
            a._prepareEvent(t, e, i).then(function(t) {
                if (null !== t) {
                    var e = t;
                    if (i && i.data && !0 === i.data.__sentry__ || !s || c)
                        return a._sendEvent(e),
                        void r(e);
                    var n = s(t, i);
                    if (void 0 === n)
                        w.error("`beforeSend` method has to return `null` or a valid event.");
                    else if (Object(f.m)(n))
                        a._handleAsyncBeforeSend(n, r, o);
                    else {
                        if (null === (e = n))
                            return w.log("`beforeSend` returned `null`, will not send event."),
                            void r(null);
                        a._sendEvent(e),
                        r(e)
                    }
    ...
    function tt(t, e) {
        ...
        (this._options = e).dsn && (this._dsn = new G(e.dsn))
    }
    (K = V = V || {}).Unknown = "unknown",
    K.Skipped = "skipped",
    K.Success = "success",
    K.RateLimit = "rate_limit",
    K.Invalid = "invalid",
    K.Failed = "failed",
    (Q = V = V || {}).fromHttpCode = function(t) {
    ...
    function st(t) {
        this._options = t,
        this._options.dsn || w.warn("No DSN provided, backend will not do anything."),
        this._transport = this._setupTransport()
    }
    function ct() {
        if (!("fetch"in Object(_.f)()))
            return !1;
        try {
            return new Headers,
            new Request(""),
    ...
    (it = rt = rt || {}).fromString = function(t) {
        switch (t) {
        case "debug":
            return it.Debug;
        case "info":
            ...
            if (e = function(t) {
                ...
                for (var e, n, r, o = [], i = t.stack.split("\n"), a = 0; a < i.length; ++a) {
                    if (n = pt.exec(i[a])) {
                        ...
                        n[2] && 0 === n[2].indexOf("eval") && (e = vt.exec(n[2])) && (n[2] = e[1],
                        n[3] = e[2],
                        n[4] = e[3]),
                        r = {
                        ...
                        if (!(n = ft.exec(i[a])))
                            continue;
                        n[3] && -1 < n[3].indexOf(" > eval") && (e = ht.exec(n[3])) ? (n[1] = n[1] || "eval",
                        n[3] = e[1],
                        n[4] = e[2],
    ...
    function St(t, e, n) {
        var r;
        if (void 0 === n && (n = {}),
        Object(f.e)(t) && t.error)
            return r = xt(yt(t = t.error));
        ...
        return Object(f.d)(t) ? r = xt(yt(t)) : (Object(f.h)(t) || Object(f.f)(t) ? r = function(t, e, n) {
            ...
            return r
        }(t, e, n.rejection) : (r = kt(t, e, n),
        Object(_.b)(r, "" + t, void 0)),
        Object(_.a)(r, {
            synthetic: !0
        }),
        r)
    ...
    function Ct(t) {
        ...
        this._api = new Rt(this.options.dsn),
        this.url = this._api.getStoreEndpointWithUrlEncodedAuth()
    }
    var Lt, Pt = Object(_.f)(), At = (Lt = Ut,
    h.b(Mt, Lt),
    Mt.prototype.sendEvent = function(t) {
        var i = this;
        ...
        return void 0 !== this.options.fetchParameters && Object.assign(n, this.options.fetchParameters),
        void 0 !== this.options.headers && (n.headers = this.options.headers),
        this._buffer.add(new d(function(r, o) {
            Pt.fetch(e.url, n).then(function(t) {
                var e = V.fromHttpCode(t.status);
                if (e !== V.Success) {
                    if (e === V.RateLimit) {
                        var n = Date.now();
                        i._disabledUntil = new Date(n + Object(_.j)(n, t.headers.get("Retry-After"))),
                        w.warn("Too many requests, backing off till: " + i._disabledUntil)
                    }
                    o(t)
                } else
                    r({
    ...
    var Ft, Bt = (Ft = Ut,
    h.b(Ht, Ft),
    Ht.prototype.sendEvent = function(t) {
        var i = this;
        if (new Date(Date.now()) < this._disabledUntil)
            return Promise.reject({
                event: t,
            ...
            for (var t in o.onreadystatechange = function() {
                if (4 === o.readyState) {
                    ...
                    if (t !== V.Success) {
                        if (t === V.RateLimit) {
                            var e = Date.now();
                            i._disabledUntil = new Date(e + Object(_.j)(e, o.getResponseHeader("Retry-After"))),
                            w.warn("Too many requests, backing off till: " + i._disabledUntil)
                        }
                        r(o)
                    } else
    ...
    var qt, Wt = (qt = at,
    h.b(Yt, qt),
    Yt.prototype._setupTransport = function() {
        if (!this._options.dsn)
            return qt.prototype._setupTransport.call(this);
    ...
    Yt.prototype.eventFromMessage = function(t, e, n) {
        return void 0 === e && (e = rt.Info),
        wt(this._options, t, e, n)
    }
    ,
    Yt);
    function Yt() {
            ...
            try {
                ...
                re(function(t) {
                    t.addEventProcessor(function(t) {
                        var e = h.a({}, t);
                        return r.mechanism && (Object(_.b)(e, void 0, void 0),
                        Object(_.a)(e, r.mechanism)),
                        e.extra = h.a({}, e.extra, {
                            arguments: n
                        }),
                        e
    ...
    function ce(t) {
        ...
        t.eventId)
            if (t.dsn) {
                ...
                e.async = !0,
                e.src = new Rt(t.dsn).getReportDialogEndpoint(t),
        ...
        if (!fe[t])
            ...
            case "dom":
                !function() {
                    if (!("document"in le))
                        return;
                    le.document.addEventListener("click", be("click", ve.bind(null, "dom")), !1),
                    le.document.addEventListener("keypress", Ee(ve.bind(null, "dom")), !1),
                        ...
                        e && e.hasOwnProperty && e.hasOwnProperty("addEventListener") && (Object(J.b)(e, "addEventListener", function(r) {
                            return function(t, e, n) {
                                return e && e.handleEvent ? ("click" === t && Object(J.b)(e, "handleEvent", function(e) {
                                    return function(t) {
                                        return be("click", ve.bind(null, "dom"))(t),
                                        e.call(this, t)
                                    }
                                }),
                                "keypress" === t && Object(J.b)(e, "handleEvent", function(e) {
                                    return function(t) {
                                        return Ee(ve.bind(null, "dom"))(t),
                                        e.call(this, t)
                                    }
                                })) : ("click" === t && be("click", ve.bind(null, "dom"), !0)(this),
                                "keypress" === t && Ee(ve.bind(null, "dom"))(this)),
                                r.call(this, t, e, n)
                            }
                        }),
                    ...
                    if (!function() {
                        ...
                        if (n && "function" == typeof n.createElement)
                            try {
                                ...
                                r.contentWindow && r.contentWindow.fetch && (e = ut(r.contentWindow.fetch)),
                        ...
                        return function() {
                            ...
                            var n = {
                                ...
                                fetchData: {
                                    method: function(t) {
                                        void 0 === t && (t = []);
                                        if ("Request"in le && Object(f.g)(t[0], Request) && t[0].method)
                                    ...
                                    url: function(t) {
                                        ...
                                        if ("string" == typeof t[0])
                                            return t[0];
                                        if ("Request"in le && Object(f.g)(t[0], Request))
                                            return t[0].url;
                                        return String(t[0])
                                    }(t)
                                },
            ...
            case "history":
                !function() {
                    ...
                    ,
                    Object(J.b)(le.history, "pushState", t),
                    Object(J.b)(le.history, "replaceState", t)
                }();
                break;
            case "error":
                xe = le.onerror,
                le.onerror = function(t, e, n, r, o) {
                    return ve("error", {
                        column: r,
                        error: o,
                        line: n,
            ...
            case "unhandledrejection":
                Oe = le.onunhandledrejection,
                le.onunhandledrejection = function(t) {
                    return ve("unhandledrejection", t),
    ...
    function he(t) {
        t && "string" == typeof t.type && "function" == typeof t.callback && (pe[t.type] = pe[t.type] || [],
        pe[t.type].push(t.callback),
        de(t.type))
    }
    function ve(e, t) {
        var n, r;
    ...
    function Ee(r) {
        return function(t) {
            ...
            var n = e && e.tagName;
            n && ("INPUT" === n || "TEXTAREA" === n || e.isContentEditable) && (_e || be("input", r)(t),
            clearTimeout(_e),
    ...
    we.prototype._consoleBreadcrumb = function(t) {
        ...
        if ("assert" === t.level) {
            if (!1 !== t.args[0])
                return;
            e.message = "Assertion failed: " + (Object(L.b)(t.args.slice(1), " ") || "console.assert"),
    ...
    var Se, ke = "sentry.javascript.browser", Te = "5.20.1", Re = (Se = Z,
    h.b(Ie, Se),
    Ie.prototype._prepareEvent = function(t, e, n) {
    ...
    Ie.prototype._sendEvent = function(t) {
        ...
        Se.prototype._sendEvent.call(this, t)
    }
    ,
    Ie.prototype.showReportDialog = function(t) {
        void 0 === t && (t = {}),
        Object(_.f)().document && (this._isEnabled() ? ce(h.a({}, t, {
        ...
        return function() {
            ...
            return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(function(n) {
                n in r && "function" == typeof r[n] && Object(J.b)(r, n, function(t) {
                    ...
                    return t.__sentry_original__ && (e.mechanism.data.handler = Object(_.e)(t.__sentry_original__)),
                    se(t, e)
                })
            }),
            n.apply(this, t)
    ...
    Ue.prototype.setupOnce = function() {
        var t = Object(_.f)();
        this._options.setTimeout && Object(J.b)(t, "setTimeout", this._wrapTimeFunction.bind(this)),
        this._options.setInterval && Object(J.b)(t, "setInterval", this._wrapTimeFunction.bind(this)),
        this._options.requestAnimationFrame && Object(J.b)(t, "requestAnimationFrame", this._wrapRAF.bind(this)),
        this._options.XMLHttpRequest && "XMLHttpRequest"in t && Object(J.b)(XMLHttpRequest.prototype, "send", this._wrapXHR.bind(this)),
    ...
    var Ce = (Le.prototype.setupOnce = function() {
        ...
        this._options.onerror && (w.log("Global Handler attached: onerror"),
        this._installGlobalOnErrorHandler()),
        this._options.onunhandledrejection && (w.log("Global Handler attached: onunhandledrejection"),
    ...
    Ae.prototype._handler = function(t, e) {
        if (!(t.exception && t.exception.values && e && Object(f.g)(e.originalException, Error)))
            return t;
        var n = this._walkErrorTree(e.originalException, this._key);
        return t.exception.values = h.d(n, t.exception.values),
        t
    }
    ,
    Ae.prototype._walkErrorTree = function(t, e, n) {
        if (void 0 === n && (n = []),
        !Object(f.g)(t[e], Error) || n.length + 1 >= this._limit)
            return n;
        var r = Et(yt(t[e]));
      ...
      , Fe = (Be.prototype.setupOnce = function() {
        b(function(t) {
            if (N().getIntegration(Be)) {
                if (!Me.navigator || !Me.location)
                    return t;
                var e = t.request || {};
                return e.url = e.url || Me.location.href,
                e.headers = e.headers || {},
    ...
    nn.prototype.enhanceEventWithErrorData = function(t, e) {
        var n;
        if (!e || !e.originalException || !Object(f.d)(e.originalException))
            return t;
        ...
        if (o) {
            ...
            return Object(f.h)(a) && (i = h.a({}, t.contexts, ((n = {})[r] = h.a({}, a),
            n))),
            h.a({}, t, {
                contexts: i
            })
    ...
    var rn, on, an, sn, cn, un, ln, pn, fn, dn, hn, vn = {
        metaData: (ln = document.querySelector('meta[name="sentry-meta"]'),
        pn = null !== (rn = null == ln ? void 0 : null === (on = ln.dataset) || void 0 === on ? void 0 : on.sampleRate) && void 0 !== rn ? rn : .5,
        {
